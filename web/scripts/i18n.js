        ...
        this.translations = {
            ru: {
                ...
                charts: {
                    ...
                    aggregation_mode: 'Агрегация',
                    aggregation_raw: 'Без агрегации',
                    aggregation_avg: 'Среднее',
                    aggregation_min: 'Минимум',
                    aggregation_max: 'Максимум',
                    aggregation_last: 'Последнее',
                    downsample_mode: 'Downsampling',
                    downsample_off: 'Выключено',
                    downsample_auto: 'Авто',
                    downsample_30s: '30 секунд',
                    downsample_1m: '1 минута',
                    downsample_5m: '5 минут',
                    downsample_15m: '15 минут',
                    downsample_1h: '1 час',
                    render_points: 'Точек на экран',
                    smoothing: 'Сглаживание (окно)',
                    show_points: 'Показывать точки',
                    show_values: 'Показывать значения',
                    group_range: 'Диапазон',
                    group_view: 'Вид',
                    fit_all: 'Fit all',
                    preset_name: 'Название пресета',
                    preset_name_placeholder: 'например: Котел-1 смена',
                    preset_select: 'Сохраненные пресеты',
                    preset_save: 'Сохранить',
                    preset_apply: 'Применить',
                    preset_delete: 'Удалить',
                    scroll_hint: 'Панорамирование: drag по X (Shift + drag для Y), колесо по X. Горячие клавиши: F = fit all, R = reset, [ / ] = диапазон.',
            ...
            kk: {
                ...
                charts: {
                    ...
                    aggregation_mode: 'Агрегация',
                    aggregation_raw: 'Агрегациясыз',
                    aggregation_avg: 'Орташа',
                    aggregation_min: 'Минимум',
                    aggregation_max: 'Максимум',
                    aggregation_last: 'Соңғы',
                    downsample_mode: 'Downsampling',
                    downsample_off: 'Өшірулі',
                    downsample_auto: 'Авто',
                    downsample_30s: '30 секунд',
                    downsample_1m: '1 минут',
                    downsample_5m: '5 минут',
                    downsample_15m: '15 минут',
                    downsample_1h: '1 сағат',
                    render_points: 'Экрандағы нүктелер',
                    ...
                    group_view: 'Көрініс',
                    fit_all: 'Fit all',
                    preset_name: 'Пресет атауы',
                    preset_name_placeholder: 'мысалы: Қазан-1 ауысым',
                    preset_select: 'Сақталған пресеттер',
                    preset_save: 'Сақтау',
                    preset_apply: 'Қолдану',
                    preset_delete: 'Жою',
                    scroll_hint: 'Панорамалау: X үшін drag (Y үшін Shift + drag), X бойынша дөңгелек. Жылдам пернелер: F = fit all, R = reset, [ / ] = диапазон.',
            ...
            en: {
                ...
                charts: {
                    ...
                    aggregation_raw: 'No aggregation',
                    aggregation_avg: 'Average',
                    aggregation_min: 'Minimum',
                    aggregation_max: 'Maximum',
                    aggregation_last: 'Last value',
                    downsample_mode: 'Downsampling',
                    downsample_off: 'Off',
                    downsample_auto: 'Auto',
                    downsample_30s: '30 seconds',
                    downsample_1m: '1 minute',
                    downsample_5m: '5 minutes',
                    downsample_15m: '15 minutes',
                    downsample_1h: '1 hour',
                    render_points: 'Render points',
                    ...
                    preset_name_placeholder: 'e.g.: Boiler-1 shift',
                    preset_select: 'Saved presets',
                    preset_save: 'Save',
                    preset_apply: 'Apply',
                    preset_delete: 'Delete',
                    scroll_hint: 'Pan with drag on X (Shift + drag for Y), wheel for X panning. Hotkeys: F = fit all, R = reset, [ / ] = range.',
